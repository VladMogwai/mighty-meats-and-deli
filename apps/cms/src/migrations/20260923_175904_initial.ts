...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_hero_call_to_action_link_type" AS ENUM('page', 'custom');
  CREATE TYPE "public"."enum_products_perfect_for" AS ENUM('bbq', 'grilling', 'frying', 'roasting', 'slow-cooking', 'stewing');
  CREATE TYPE "public"."enum_videos_source" AS ENUM('embed', 'upload');
  ...
  CREATE TYPE "public"."enum_navigation_main_menu_link_type" AS ENUM('page', 'custom');
  CREATE TABLE "pages_blocks_hero_call_to_action" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_label" varchar NOT NULL,
  	"link_type" "enum_pages_blocks_hero_call_to_action_link_type" DEFAULT 'page',
  ...
  CREATE TABLE "pages_blocks_featured_products" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar DEFAULT 'Customer favorites',
  	"intro" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_partner_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "products_perfect_for" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_products_perfect_for",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "videos" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"source" "enum_videos_source" DEFAULT 'embed',
  	"url" varchar,
  	"file_id" integer,
  	"poster_id" integer,
  	"description" varchar,
  ...
  CREATE TABLE "navigation_main_menu" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_label" varchar NOT NULL,
  	"link_type" "enum_navigation_main_menu_link_type" DEFAULT 'page',
  	"link_page_id" integer,
  	"link_url" varchar,
  	"link_new_tab" boolean
  );
  ...
  ALTER TABLE "pages_blocks_hero_call_to_action" ADD CONSTRAINT "pages_blocks_hero_call_to_action_link_page_id_pages_id_fk" FOREIGN KEY ("link_page_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero_call_to_action" ADD CONSTRAINT "pages_blocks_hero_call_to_action_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_hero"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_steps_steps" ADD CONSTRAINT "pages_blocks_steps_steps_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_partner_list" ADD CONSTRAINT "pages_blocks_partner_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products_perfect_for" ADD CONSTRAINT "products_perfect_for_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "videos" ADD CONSTRAINT "videos_file_id_media_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "navigation_main_menu" ADD CONSTRAINT "navigation_main_menu_link_page_id_pages_id_fk" FOREIGN KEY ("link_page_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_call_to_action_order_idx" ON "pages_blocks_hero_call_to_action" USING btree ("_order");
  CREATE INDEX "pages_blocks_hero_call_to_action_parent_id_idx" ON "pages_blocks_hero_call_to_action" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_hero_call_to_action_link_link_page_idx" ON "pages_blocks_hero_call_to_action" USING btree ("link_page_id");
  ...
  CREATE INDEX "pages_blocks_steps_steps_image_idx" ON "pages_blocks_steps_steps" USING btree ("image_id");
  ...
  CREATE INDEX "pages_blocks_partner_list_order_idx" ON "pages_blocks_partner_list" USING btree ("_order");
  CREATE INDEX "pages_blocks_partner_list_parent_id_idx" ON "pages_blocks_partner_list" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_partner_list_path_idx" ON "pages_blocks_partner_list" USING btree ("_path");
  ...
  CREATE INDEX "products_perfect_for_order_idx" ON "products_perfect_for" USING btree ("order");
  CREATE INDEX "products_perfect_for_parent_idx" ON "products_perfect_for" USING btree ("parent_id");
  ...
  CREATE INDEX "videos_file_idx" ON "videos" USING btree ("file_id");
  ...
  CREATE INDEX "navigation_main_menu_link_link_page_idx" ON "navigation_main_menu" USING btree ("link_page_id");`)
}

export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "pages_blocks_hero_call_to_action" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_hero_call_to_action_link_type";
  DROP TYPE "public"."enum_products_perfect_for";
  DROP TYPE "public"."enum_videos_source";
  DROP TYPE "public"."enum_site_settings_opening_hours_days";
  DROP TYPE "public"."enum_site_settings_social_links_platform";
  DROP TYPE "public"."enum_navigation_main_menu_link_type";`)
}
